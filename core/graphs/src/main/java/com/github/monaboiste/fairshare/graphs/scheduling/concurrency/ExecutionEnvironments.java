package com.github.monaboiste.fairshare.graphs.scheduling.concurrency;

import com.github.monaboiste.fairshare.graphs.scheduling.ProcessStep;
...
record ExecutionEnvironments(Map<ProcessStep, Integer> stepToEnvironment) {
    ExecutionEnvironments {
        stepToEnvironment = Map.copyOf(stepToEnvironment);
    }
