...
class InfluenceMap {
    ...
    private static void addInfrastructure(
            InfrastructureInfluence infrastructureInfluence, Graph<InfluenceUnit, DefaultEdge> result) {
    ...
    boolean influences(PhysicsProcess fromProcess, Laboratory fromLab, PhysicsProcess toProcess, Laboratory toLab) {
        return graph.containsEdge(new InfluenceUnit(fromProcess, fromLab), new InfluenceUnit(toProcess, toLab))
    }
    ...
    static class Builder {
        ...
        InfluenceMap build() {
            PhysicsInfluence physics = requireNonNull(physicsInfluence, "physicsInfluence")
            if (laboratoryAdjacency != null) {
                return of(physics, infrastructureInfluence, laboratoryAdjacency)
            }
            return of(physics, infrastructureInfluence, requireNonNull(laboratories, "laboratories"))
        }
    }
}
