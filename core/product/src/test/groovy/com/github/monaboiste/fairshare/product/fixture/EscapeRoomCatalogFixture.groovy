package com.github.monaboiste.fairshare.product.fixture

import com.github.monaboiste.fairshare.product.ApplicabilityConstraint
import com.github.monaboiste.fairshare.product.CatalogEntry
import com.github.monaboiste.fairshare.product.CatalogEntryId
import com.github.monaboiste.fairshare.product.PackageType
import com.github.monaboiste.fairshare.product.Product
import com.github.monaboiste.fairshare.product.ProductDescription
import com.github.monaboiste.fairshare.product.ProductFeatureType
import com.github.monaboiste.fairshare.product.ProductIdentifier
import com.github.monaboiste.fairshare.product.ProductMetadata
import com.github.monaboiste.fairshare.product.ProductName
import com.github.monaboiste.fairshare.product.ProductRelationship
import com.github.monaboiste.fairshare.product.ProductRelationshipDefiningPolicy
import com.github.monaboiste.fairshare.product.ProductRelationshipFactory
import com.github.monaboiste.fairshare.product.ProductRelationshipId
import com.github.monaboiste.fairshare.product.ProductRelationshipType
import com.github.monaboiste.fairshare.product.ProductTrackingStrategy
import com.github.monaboiste.fairshare.product.ProductType
import com.github.monaboiste.fairshare.product.Validity
...
final class EscapeRoomCatalogFixture {
    ...
    static final ProductType ALCATRAZ = ProductType.builder(
            ...
            .withApplicabilityConstraint(ApplicabilityConstraint.not(ApplicabilityConstraint.equalsTo("claustrophobia", "true")))
            .build()
    ...
    private static PackageType buildHardcore() {
        Product.builder(
                ...
                .withApplicabilityConstraint(ApplicabilityConstraint.greaterThan("age", 17))
                .build()
    }
    ...
    static List<CatalogEntry> catalogEntriesFor(String city) {
        ...
        if ("Warsaw" == city) {
            entries.add(entry(CYBERPUNK_2077, "room", ApplicabilityConstraint.and(ApplicabilityConstraint.equalsTo("city", "Warsaw"), ApplicabilityConstraint.equalsTo("hasVrEquipment", "true"))))
        }

        entries.add(entry(ACTOR, "addon", ApplicabilityConstraint.in("dayType", "Saturday", "Sunday")))
