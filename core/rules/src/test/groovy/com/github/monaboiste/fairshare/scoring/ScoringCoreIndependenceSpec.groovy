...
class ScoringCoreIndependenceSpec extends Specification {
    ...
    private static final List<Path> CORE = [
            Path.of("src/main/java/com/github/monaboiste/fairshare/scoring/ast"),
            Path.of("src/main/java/com/github/monaboiste/fairshare/scoring/algebra"),
            Path.of("src/main/java/com/github/monaboiste/fairshare/scoring/context"),
            Path.of("src/main/java/com/github/monaboiste/fairshare/scoring/EventRuleEngine.java")
    ]

    private static final List<String> FORBIDDEN = [
            "com.github.monaboiste.fairshare.scoring.customer",
            "Customer",
            "PURCHASE_AMOUNT",
            "COMPLAINT"
    ]
